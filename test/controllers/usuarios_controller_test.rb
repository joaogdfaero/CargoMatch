...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference("Usuario.count") do
      post usuarios_url, params: { usuario: { cpf: @usuario.cpf, nome: @usuario.nome, tipo: @usuario.tipo } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { cpf: @usuario.cpf, nome: @usuario.nome, tipo: @usuario.tipo } }
